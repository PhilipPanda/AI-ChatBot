...
- Multiple chat modes (Creative, Concise, ELI5, Security Audit)
- File upload support (PDFs, code files, documents)
- Beautiful dark theme with smooth animations
- Real-time streaming responses
- Secure authentication and conversation management
